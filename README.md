...
**Portafolio** is project of a clean web application portafolio to showcases different projects activities and more. Features will be constantly updated.
...
- **Clean webpage**
- **Header using the best practices for HTML5/CSS**
- **Headline using the best practices for HTML5/CSS**
...
**Works** and **About** sections will be added next.
